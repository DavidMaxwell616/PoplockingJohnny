function preload() {
  ...
  this.load.spritesheet('gliding', 'gliding.png', {frameWidth: 159, frameHeight: 300});
  ...
  this.load.spritesheet('puppet', 'puppet.png', {frameWidth: 180, frameHeight: 300});
  ...
  this.load.spritesheet('waving', 'waving.png', {frameWidth: 179, frameHeight: 300});
  this.load.spritesheet('boogaloo', 'boogaloo.png', {frameWidth: 166, frameHeight: 300});
}
